...
export const Destination = () => {
    ...
    const portfolioImages = [
        { src: IMAGES.tienxwilliam, title: 'Beach Wedding' },
        { src: IMAGES.nathanxtracy, title: 'Garden Wedding' },
        { src: IMAGES.service, title: 'Outdoor Ceremony' },
        { src: IMAGES.mayxmat, title: 'Rustic Wedding' }
    ];
